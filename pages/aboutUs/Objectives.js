...
const Objectives = () => {
    ...
    const vision = <>
        <div className='flex  flex-col lg:flex-row  items-center'>
            <div className='relative w-[300px] h-[300px] lg:w-[500px] lg:h-[300px]'>
    ...
    const objective = <div className='flex flex-col lg:flex-row items-center'>
        <div className='relative w-[280px] h-[280px] lg:w-[500px] lg:h-[300px] xl:w-[500px] xl:h-[300px]'>
    ...
    const value = <div className='flex flex-col lg:flex-row items-center'>
        ...
        <div className='lg:ml-28 px-5 lg:px-0'>
            ...
            <div className='flex flex-col lg:flex-row space-y-2 lg:space-y-0 space-x-2 xl:space-x-10'>
                ...
                <div>
                    <h1 className='font-medium text-lg xl:text-2xl mb-2'>Accountability</h1>
                ...
                <div>
                    <h1 className='font-medium text-lg xl:text-2xl mb-2'>Contribution</h1>
    ...
    return (
        <div>
            ...
            <div className='w-full lg:ml-5 xl:w-[70rem] lg:h-[25rem]'>
                {
                    visiond && vision
                }
                {
