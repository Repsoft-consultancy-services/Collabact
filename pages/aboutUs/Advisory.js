            ...
            <div className='my-20 grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-16 px-5 2xl:px-0'>
                <div className='border-2 border-gray-500 rounded-[20px] flex flex-col items-center py-5 px-2 shadow-[0px_6px_33px_0_rgba(0,0,0,0.30)] 2xl:w-[350px] '>
                    ...
                    <div className='mt-2 text-center'>
                        ...
                        <p className='mt-5 text-xs lg:text-base'>Rishiji, a spiritual mentor, singer and author of the best-selling book &apos;&apos;Celebrating Life&apos;&apos;. This modern Rishi was always perceived as a &apos;spiritual scientist&apos;, bursting with love, energy and a never-dying enthusiasm to serve humanity.</p>
                    </div>
                </div>
                <div className='border-2 border-gray-500 rounded-[20px] flex flex-col items-center py-5 px-2 shadow-[0px_6px_33px_0_rgba(0,0,0,0.30)] 2xl:w-[350px]'>
                    <div className='rounded-full border-4 border-[#F4B50D] relative w-20 h-20 xl:w-56 xl:h-56'>
                    ...
                    <div className='mt-2 text-center'>
                        ...
                        <p className='mt-5 text-xs lg:text-base'>Ekata Mehul, Director and CEO - Orena Solutions and Blazing Arrows Pvt. Ltd. She is Co-director for “Women in Big Data”. Director for “Ignite” and Brand Ambassador for “Impulse of Women” at India level.</p>
                    </div>
                </div>
                <div className='border-2 border-gray-500 rounded-[20px] flex flex-col items-center py-5 px-2 shadow-[0px_6px_33px_0_rgba(0,0,0,0.30)] 2xl:w-[350px]'>
                    <div className='rounded-full border-4 border-[#F4B50D] relative w-20 h-20 xl:w-56 xl:h-56'>
                    ...
                    <div className='mt-2 text-center'>
                        ...
                        <p className='mt-5 text-xs lg:text-base'> Director, Shreelight Power Pvt.Ltd Has more than 25 years of experience in the field Precedent, Vadodara Electrical Licensed Contractor Association (VELCA)</p>
                    </div>
                </div>
                <div className='border-2 border-gray-500 rounded-[20px] flex flex-col items-center py-5 px-2 shadow-[0px_6px_33px_0_rgba(0,0,0,0.30)] 2xl:w-[350px]'>
                    <div className='rounded-full border-4 border-[#F4B50D] relative w-20 h-20 xl:w-56 xl:h-56'>
                    ...
                    <div className='mt-2 text-center'>
                        ...
                        <p className='mt-5 text-xs lg:text-base'> Founder & Strategic Consultant at Root2Ray IIM-Ahmedabad alumnus Certified Strategic Consultant from IIM-Bangalore</p>
                    </div>
                </div>
            </div>
        </div>
