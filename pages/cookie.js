            ...
            <div className='p-10 mx-auto w-4/5 2xl:w-[94rem] bg-white mt-10'>
                <div className='px-20'>
                    ...
                    <p className=' font-semibold'>
                        In this website,we believe in transparent about how we collect and use data.
                        This policy provides information about how and when we use  cookies for these purpose.
                        Capitalized terms used in the policy but not defined have the meaingn set forth in our
                        Privacy Policy,which also includes additional details about the collection and use of information in this website.
                        <br />
                    </p>
                    <h1 className=' font-bold mt-5'>
                        What is a cookie?
                    ...
                    <p className=' font-semibold'>
                        ...
                        Performance & Analytical cookies: These cookies enable us to monitor and improve the performance of our website. For example, they allow us to count visits, identify traffic sources and see which parts of the site are most popular. Functionality cookies: These cookies allow our website to remember choices you make and provide enhanced features. For instance, we may be able to provide you with news or updates relevant to the services you use. They may also be used to provide services you have requested such as viewing a video or commenting on a blog. The information these cookies collect is usually anonymised.<br />

                        What can you do if you don&apos;t want cookies to be set or want them to be removed?<br /> Some people prefer not to allow cookies, which is why most browsers give you the ability to manage cookies to suit you. In some browsers you can set up rules to manage cookies on a site-by-site basis, giving you more fine-grained control over your privacy. What this means is that you can disallow cookies from all sites except those that you trust.<br /><br />
                        Browser manufacturers provide help pages relating to cookie management in their products. Please see below for more information.<br /><br />
                        Google Chrome<br />
