...
const Banner = () => {
    return (
        <div className='px-20 2xl:px-0 w-full 2xl:w-[1621px] xl:h-[672.2px] 2xl:h-[686.4px]'>
            <div className="bg-[url('/contact/bg.png')] bg-no-repeat bg-cover bg-center text-white h-screen 2xl:w-[1621px] xl:h-[672.2px] 2xl:h-[686.4px] flex items-end rounded-[100px]">
