      ...
      <div className="flex flex-col lg:flex-row lg:space-x-3 xl:space-x-0 justify-between px-2 md:px-10 mt-16">
          ...
          <div className="relative z-50 flex flex-col-reverse h-auto w-full">
            <div className="flex space-x-10 justify-center mt-10">
              <div ref={navigationPrevRef}>
                <button className="bg-white text-blue-500 border-0 shadow-[3px_4px_36px_0_rgba(0,0,0,0.30)] p-2 text-xs lg:text-base rounded-full">
            ...
            >
              <SwiperSlide>
                <div className="text-base md:text-[20px] xl:text-[26px] flex justify-between space-x-10 sm:space-x-20 mt-10 w-10/12">
                  ...
                  <div className="space-y-5">
                    <h1 className="font-bold text-[#0099E6] text-lg leading-5">
                      Business Introductory <br /> Meeting
                    </h1>
                    <p className="text-[#757575] text-lg">
                      On 20th Sept at 4.30 pm
                    </p>
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="text-base md:text-[20px] xl:text-[26px] flex justify-between space-x-10 sm:space-x-20 mt-10 w-10/12">
                  ...
                  <div className="space-y-5">
                    <h1 className="font-bold text-[#0099E6] text-lg">
                      Business Introductory <br /> Meeting
                    </h1>
                    <p className="text-[#757575] text-lg">
                      On 20th Sept at 4.30 pm
              ...
              <SwiperSlide>
                <div className="text-base xl:text-[26px] flex justify-between space-x-10 sm:space-x-20 mt-10 w-10/12">
                  <div className="space-y-5">
                    <h1 className="font-bold text-[#0099E6] text-lg leading-5">
                      Upgrade sessions for <br /> Entrepreneurship
                    </h1>
        ...
        <div className="mt-5 lg:mt-0">
          ...
          <div className="mt-10 lg:w-[28rem]  xl:w-[30rem]">
            <div className="bg-[#0099E6] message flex justify-between space-x-10 items-center p-6 rounded-md h-40">
              <div>video</div>
              <div>
            ...
            <div className="flex mt-2 space-x-5">
              ...
              <div>
                <h4 className="text-[26px] text-[#0099E6] font-bold">
                  Mr. Parag Shah
                </h4>
                <p className="text-[19px] text-[#0099E6]">Ahmedabad </p>
                <p className="text-[22px]">
                  Director, TriQuench India Pvt. Ltd.
                </p>
              </div>
            </div>
          </div>
