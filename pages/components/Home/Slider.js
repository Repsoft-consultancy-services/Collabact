  ...
  return (
    <div className="w-full mt-10 lg:mt-20">
      <div className="max-w-[85rem] mx-auto py-10">
        <h1 className="text-2xl lg:text-5xl text-[#F4B50D] text-center font-bold mb-10 lg:mb-20">
          Encash Out Businesses
        </h1>
        {/* laptop slider */}
        <div className="hidden md:block">
          <div className="relative z-10 flex items-center space-x-3 h-auto px-2">
            <div ref={navigationPrevRef} className="order-1">
              <button className="bg-white text-blue-500 active:bg-blue-500 active:text-white border-0 p-3 shadow-[3px_4px_36px_0_rgba(0,0,0,0.30)] text-xs lg:text-base rounded-full">
                <FaLessThan />
              </button>
            </div>
              ...
              {data.map((d, index) => (
                <Link key={index} href="https://app.collabact.com/Account">
                  <SwiperSlide key={index}>
                    <div className="bg-white w-[350px] shadow-[0px_0px_8px_0_rgba(0,0,0,0.30)] hover:shadow-[0px_0px_8px_0_rgba(0,0,0,0.50)] shadow-gray-500 hover:shadow-gray-600 hover:cursor-pointer w-9/12 h-10/12">
                      <div>
                        <div className="flex items-center space-x-3 p-5 bg-slate-100 h-[150px]">
                          ...
                          <h1 className="text-base xl:text-2xl font-bold text-left flex-1">
                            {d.title}
                          </h1>
                        </div>
                        <div className="border-b-2 border-gray-300 w-full"></div>
                        <div className="text-left ml-3 space-y-3 mt-3">
                          <h6 className="text-sm xl:text-base">
