    ...
    return (
        <div className='max-w-[100rem] mx-auto'>
            ...
            <div className='flex justify-between items-end 2xl:space-x-6'>
                ...
                <div className="bg-[url('/bg.png')] bg-no-repeat bg-cover bg-center text-white h-[225px] md:h-[400px] lg:h-[476px] xl:h-[550px] 2xl:h-[600px] flex-1 rounded-[10px] lg:rounded-[50px]">
            ...
            <div className="w-[85vw] sm:w-[350px] lg:w-[550px] xl:w-[700px] 2xl:w-[750px] ml-[7.2vw] sm:ml-[2.4rem] md:ml-[23rem] lg:ml-auto -mt-11 md:-mt-10 lg:-mt-[150px] xl:-mt-40 mr-14">
