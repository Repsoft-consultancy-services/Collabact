...
const Banner = () => {
    return (
        <div className='w-full xl:w-[1300px] 2xl:w-[1400px] mb-10 lg:mr-16 2xl:mr-40'>
            ...
            <div className="w-[85vw] sm:w-[350px] lg:w-[550px] xl:w-[700px] 2xl:w-[750px] ml-[7.2vw] sm:ml-[2.4rem] md:ml-[23rem] lg:ml-[25rem] xl:ml-auto -mt-11 md:-mt-10 lg:-mt-[150px] xl:-mt-40 mr-14">
                ...
                <div className="flex justify-between w-11/12 mx-auto relative -mt-3 z-[5] lg:space-x-28 xl:space-x-5">
                    <div>
                        <div className="bg-white w-[30vw] md:w-[20vw] lg:w-[200px] xl:w-[250px] flex flex-col items-center 2xl:ml-3">
                            <h1 className="text-center text-[3vw] lg:text-lg xl:text-[1.4rem] font-bold mt-2">Businesses</h1>
                            ...
                            <div className='bg-[#b8bdc2] w-[45vw] sm:w-[180px] lg:w-[290px] xl:w-[340px] relative -mt-10 lg:-mt-16 shadow-[0px_1px_30px_0_rgba(0,0,0,0.30)] md:shadow-[0px_1px_64px_0_rgba(0,0,0,0.30)]'>
                        ...
                        <div className='flex justify-center relative -mt-[4vw] sm:-mt-6'>
                            <button className='py-[2vw] px-[2vw] sm:py-3 sm:px-5 lg:px-10 xl:px-20 buttonbg rounded-full text-white font-semibold lg:font-bold uppercase text-[3vw] lg:text-sm xl:text-lg'>join us</button>
                        </div>
                    </div>
                    <div>
                        <div className="bg-white w-[30vw] lg:w-[200px] xl:w-[250px] flex flex-col items-center 2xl:mr-3">
                            <h1 className="text-center text-[3vw] lg:text-lg xl:text-[1.4rem] font-bold mt-2">Sales Partners</h1>
                            <div className='p-5 z-[5]'>
                                <div className='relative -mt-3 lg:-mt-0 w-[32px] h-[32px] lg:w-[70px] lg:h-[70px]'>
                        ...
                        <div className='flex justify-center relative -mt-[4vw] sm:-mt-6'>
                            <button className='py-[2vw] px-[2vw] sm:py-3 sm:px-5 md:px-10 xl:px-14 buttonbg2 rounded-full text-black font-semibold lg:font-bold text-[3vw] md:text-sm xl:text-lg'><span className='text-[#FF0000] mr-1'>FREE</span>Registrations</button>
                        </div>
                    </div>
