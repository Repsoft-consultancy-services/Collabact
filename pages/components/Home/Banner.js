...
const Banner = () => {
    return (
        <div className='mt-5 w-full xl:w-[1300px] 2xl:w-[1400px] mb-10 lg:mr-16 2xl:mr-40'>
            <div className='flex justify-between items-end 2xl:space-x-6 px-5'>
                ...
                <div className="bg-[url('/bg.png')] bg-no-repeat bg-cover bg-center text-white h-[262px] w-full lg:w-full lg:h-[476px] xl:h-[600px] flex-1 rounded-[10px] lg:rounded-[50px]">
            ...
            <div className="w-[325px] lg:w-[550px] xl:w-[700px] 2xl:w-[750px] ml-auto lg:ml-[25rem] xl:ml-auto -mt-10 lg:-mt-[150px] xl:-mt-40 mr-14">
                ...
                <div className="flex justify-between w-11/12 mx-auto relative -mt-3 z-[5] lg:space-x-28 xl:space-x-5">
                    <div>
                        <div className="bg-white w-[125px] lg:w-[200px] xl:w-[250px] flex flex-col items-center 2xl:ml-3">
                            <h1 className="text-center text-[12px] lg:text-lg xl:text-[1.4rem] font-bold mt-2">Businesses</h1>
                        ...
                        <div className='flex justify-center relative -mt-6'>
                            <button className='py-3 px-5 lg:px-10 xl:px-20 buttonbg rounded-full text-white font-semibold lg:font-bold uppercase text-[10px] lg:text-sm xl:text-lg'>join us</button>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='flex justify-center relative -mt-6'>
                            <button className='py-3 px-5 lg:px-10 xl:px-14 buttonbg2 rounded-full text-black font-semibold lg:font-bold text-[10px] lg:text-sm xl:text-lg'><span className='text-[#FF0000] mr-1'>FREE</span>Registrations</button>
                        </div>
                    </div>
