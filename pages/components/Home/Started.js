                ...
                <div className='flex items-center justify-between flex-col-reverse lg:flex-row text-center lg:text-left sm:mt-0'>
                    <Slide triggerOnce={1} duration={2000}>
                        <div className='ml-5 2xl:ml-0 max-w-[69rem]'>
                            <h1 className='text-xl lg:text-[33px] font-semibold'>Get started!</h1>
                            <h1 className='text-2xl lg:text-4xl xl:text-6xl font-semibold mt-16'>With India&apos;s Fastest Growing<br /> Collaboration Platform</h1>
                            <p className='mt-3 text-[14px] lg:text-sm xl:text-[27px] xl:leading-normal text-[#575757]'>For Businesses, CollabAct connects Commission-based Sales Partners who become their extended hand and help them expand their businesses in PAN India. And for the Sales Partners, we offer established companies whose products services they can sell without any investment.</p>
