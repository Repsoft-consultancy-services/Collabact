...
const Encash3 = () => {
    ...
    return (
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-10 py-5'>
            {
                data.map((d, index) => <Link key={index} href="https://app.collabact.com/Account">
                    <div className='shadow-[0px_3px_10px_0_rgba(0,0,0,0.30)] hover:shadow-[0px_3px_20px_0_rgba(0,0,0,0.50)] hover:shadow-blue-600'>
